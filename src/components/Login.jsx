  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      ...
      <div className="relative bg-white p-6 rounded-3xl shadow-xl w-[400px] md:w-[450px] z-50">
        <button
          onClick={onClose}
          className="absolute top-2 right-2 p-2 rounded-full hover:bg-gray-200 transition duration-300 border border-black-600"
        >
        ...
        {showForgotPasswordForm ? (
          ...
          <>
            ...
            <button
              ...
              className="mt-3 text-blue-600 hover:underline block text-center w-full"
            >
              Back to Login
            </button>
          </>
