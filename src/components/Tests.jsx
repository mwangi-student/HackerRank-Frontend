    ...
    <div className="gap-5">
      ...
      <div className="w-[1000px] h-auto grid grid-cols-3 gap-2 my-10">
        {TestLanguages.map((test) => (
            <div key={test.index} className="flex gap-4 w-[300px] items-center bg-white hover:bg-[#ebebf3] hover:cursor-pointer py-3.5 px-4 mb-4 rounded-lg" onClick={() => {navigate(`/practice/${test.language}`)}}>
            <div>{test.icon}</div>
